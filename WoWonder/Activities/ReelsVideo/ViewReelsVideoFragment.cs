...
namespace WoWonder.Activities.ReelsVideo
{
    public class ViewReelsVideoFragment : Fragment, IYouTubePlayerInitListener, StTools.IXAutoLinkOnClickListener
    {
        ...
        private ImageView IconBack, IconAddReel;
        ...
        private void InitComponent(View view)
        {
            try
            {
                ...
                IconAddReel = view.FindViewById<ImageView>(Resource.Id.addReel);
        ...
        private void AddOrRemoveEvent(bool addEvent)
        {
            try
            {
                ...
                if (addEvent)
                {
                    ...
                    IconAddReel.Click += IconAddReelOnClick;
        ...
        private void IconAddReelOnClick(object sender, EventArgs e)
        {
            try
            {

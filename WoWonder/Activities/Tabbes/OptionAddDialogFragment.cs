    ...
    public class OptionAddDialogFragment : BottomSheetDialogFragment
    {
        ...
        private void LoadDataChat()
        {
            try
            {
                ...
                {
                    Id = "1",
                    Text = GetText(Resource.String.Lbl_Create_Post),
                    Icon = Resource.Drawable.icon_addpost_image_vector,
                });
                ...
                if (AppSettings.ReelsPosition is not ReelsPosition.None)
                {
                    MAdapter.ItemOptionList.Add(new Classes.ItemOptionObject
                    {
                        Id = "7",
                        Text = GetText(Resource.String.Lbl_Create_ReelVideo),
                        Icon = Resource.Drawable.icon_video_reels_vector,
                    });
                }

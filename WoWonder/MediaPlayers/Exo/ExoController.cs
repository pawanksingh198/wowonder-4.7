...
namespace WoWonder.MediaPlayers.Exo
{
    public class ExoController
    {
        ...
        private LinearLayout MainVideoControlLayout;
        ...
        public void SetPlayer(PlayerView playerView, bool useController = true)
        {
            try
            {
                ...
                MainVideoControlLayout = PlayerView.FindViewById<LinearLayout>(Resource.Id.mainVideoControlLayout);
        ...
        public void FirstPlayVideo(Uri uri)
        {
            try
            {
                ...
                new Handler(Looper.MainLooper).PostDelayed(() =>
                {
                    try
                    {
                        if (VideoPlayer.PlaybackState == IPlayer.StateReady)
                        {
                            MainVideoControlLayout.SetBackgroundResource(0);
                        }
                    }
                    catch (Exception e)
                    {
